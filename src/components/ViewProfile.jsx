...
// import { getAppointmentByEmailAction } from "../actions/PatientActions.jsx";
...
//                         <br/>
//                         <TableRow style={{textAlign:'center'}}><h4 className='font-loader'>Name: {patient.adminName}</h4></TableRow>
//                         <br/>
