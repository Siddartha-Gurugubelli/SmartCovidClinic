...
//                   }}
//                 >
//                   <NavLink to="/patient/viewprofile" style={{ color:'Black', textDecoration: 'none' }}>
//                   <h3>View Profile</h3>
//                   </NavLink>
//                 </Paper>
//               </Grid>
...
//                   }}
//                 >
//                   <NavLink to="/doctortable" style={{ color:'Black',textDecoration: 'none' }}>
//                   <h2>View Doctors</h2>
//                   </NavLink>
//                 </Paper>
//               </Grid>
        ...
        <Container maxWidth='lg' sx={{ mt: 2, mb: 1 }} >
            <Grid container spacing={3}>
              ...
              <Grid item xs={5} md={2} lg={4} >
                ...
                >
                  <NavLink to="/patient/viewAppointment" style={{ color:'Black', textDecoration: 'none' }}>
                  <h3>View Appointment</h3>
                  </NavLink>
                </Paper>
              </Grid>
              <Grid item xs={5} md={2} lg={6}>
                ...
                >
                  <NavLink to="/patient/update/:id" style={{ color:'Black',textDecoration: 'none' }}>
                  <h3>Book Appointment</h3>
                  </NavLink>
                </Paper>
              </Grid>
